...
def testimage():
    """
    pil3k lets you create in-memory images with various pixel types:
    ...
    pil3k doesn't actually load the image data until it's needed,
    ...
    pil3k can do many other things, but I'll leave that for another
...
if __name__ == "__main__":
    ...
    print("-"*68)
    print("pil3k", Image.VERSION, "TEST SUMMARY ")
    print("-"*68)
    ...
    if status[0]:
        print("*** {0} tests of {1} failed.".format(*status))
        exit_status = 1
    else:
        print("--- {0} tests passed.".format(status[1]))
