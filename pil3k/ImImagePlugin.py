...
class ImImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        while True:
            ...
            if not s or s[0] == b'\x00' or s[0] == b'\x1a':
                break
            ...
            if m:
                ...
                raise SyntaxError("Syntax error in IM header: {0}".format(s))
